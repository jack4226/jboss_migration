...
public class SubscriberTest {
	...
	public void lookupABean() throws NamingException {
		Object object = ejbContainer.getContext().lookup("java:global/MsgUI2/subscriberBean");
	...
	public void testSubscriberRemote() {
		try {
			SubscriberRemote rmt = (SubscriberRemote) TomeeCtxUtil.getLocalContext().lookup(
					"java:global/MsgUI2/subscriberBean!com.es.ejb.subscriber.SubscriberRemote");
	...
	public void testSubscriberLocal() {
		try {
			SubscriberLocal subr = (SubscriberLocal) TomeeCtxUtil.getLocalContext().lookup(
					"java:global/MsgUI2/subscriberBean!com.es.ejb.subscriber.SubscriberLocal");
